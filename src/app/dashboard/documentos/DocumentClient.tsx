  ...
  return (
    <div className="space-y-6">
      ...
      <div 
        ...
        className="border-2 border-dashed border-slate-300 rounded-[2rem] p-10 cursor-pointer hover:border-teal-500 hover:bg-teal-50/50 transition-all flex flex-col items-center justify-center text-center group bg-white shadow-sm"
      >
            ...
            {documents.map(doc => (
              <div key={doc.id} className="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-slate-50/50 transition-colors">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-teal-50 rounded-xl flex items-center justify-center text-teal-600 border border-teal-100 shrink-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a 
                    href={doc.fileUrl} 
                    target="_blank" 
                    className="p-3 text-teal-600 bg-teal-50 border border-teal-100 rounded-xl hover:bg-teal-100 transition-colors font-bold flex items-center gap-2 shadow-sm"
                  >
            ...
            <form onSubmit={handleUpload} className="p-6 space-y-5">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3.5 focus:ring-2 focus:ring-teal-500 outline-none font-medium"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select 
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3.5 focus:ring-2 focus:ring-teal-500 outline-none font-medium text-slate-700"
                  >
              ...
              <div>
                ...
                <div className="w-full border-2 border-dashed border-slate-300 rounded-xl p-6 bg-slate-50 relative focus-within:ring-2 focus-within:ring-teal-500 transition-all hover:bg-slate-100">
                  <input 
                    type="file" 
                  ...
                  <div className="text-center pointer-events-none">
                    {selectedFile ? (
                      <div className="font-bold text-teal-700 break-all">{selectedFile.name} ({(selectedFile.size/1024/1024).toFixed(2)} MB)</div>
                    ) : (
              ...
              <div className="flex gap-3 pt-4 border-t border-slate-100">
                ...
                <button type="submit" disabled={loading} className="flex-1 bg-teal-600 hover:bg-teal-700 text-white font-bold py-3.5 rounded-xl transition-all shadow-lg active:scale-95 disabled:opacity-50 flex justify-center items-center gap-2">
